...
import { GITHUB_TOKEN, NO_RELEASES_FOUND, NOT_FOUND, OCTOKIT_NOT_INITIALIZED, PULL_REQUEST_SEARCH_FAILED as PULL_REQUEST_SEARCH_FAILED, REFS_HEADS, } from "../constants/github-constants";
let octokit = null;
