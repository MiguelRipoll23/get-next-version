...
import { INVALID_VERSION_NAME, CHANNEL, MAJOR, MAJOR_LABELS, MINOR, MINOR_LABELS, NEW_BUILD_FOR_PRERELEASE, NO_CHANGES_FOUND, PATCH, PATCH_LABELS, PRERELEASE, STABLE, UNKNOWN, V, } from "../constants/version-constants";
...
async function getKindByPullRequestsLabels(tagName, tagCreatedAt) {
